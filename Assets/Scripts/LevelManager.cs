...
public class LevelManager : MonoBehaviour {
	...
	static int[] shipList2 = {1,1,1,2,2};
	static int[] shipList3 = {1,1,1,1,2,2,2};
	static int[] shipList4 = {1,1,1,1,1,2,2,3};
	static int[] shipList5 = {1,1,1,1,2,2,2,3,3};
